    ...
    <Layout title="CX Demo Hub">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <Section title="📐 Architecture Overview – Headless CX & AI">
          <div className="rounded-xl bg-gray-50 p-6 shadow-sm text-center">
            <Image
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              Composable Architecture Diagram · Ricardo Pietroforte · CX | AI | Headless Commerce
            </p>
          </div>
        </Section>
        ...
        <section className="mt-16 mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            {[
              ...
              <div key={title} className="p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition">
                <h4 className="font-semibold text-indigo-700 text-lg mb-2">{title}</h4>
